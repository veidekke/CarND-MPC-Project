...
// CTE, epsi and velocity reference values
double ref_cte = 0;
double ref_epsi = 0;
double ref_v = 50;

// To address values in Vector more easily
size_t x_start = 0;
...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // Any additions to the cost are then added to `fg[0]`.
    fg[0] = 0;
    ...
    for (int t = 1; t < N; t++) {
      ...
      // For future values of the actuators use the value from the prediction before.
      // This tries to counter the 100ms latency.
      if (t > 1) {
